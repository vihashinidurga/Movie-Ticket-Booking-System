...
class MTBS{
    ...
    static{
        try{
            ...
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/mtbs","root","Agrud*2004");
        }
    ...
    public static boolean login() throws SQLException{
        ...
        if(username.equals("Durga") && password.equals("pas")){
            return true;
        }
        else{
            return false;
    ...
    public static void AddNewMovie() throws SQLException{
        try{
            ...
            System.out.println("\t\t\t\tShow Time(HH:MM:SS): ");
            System.out.print("\t\t\t\t");
            ...
            java.util.Date tim = new java.util.Date();
            java.sql.Time t1 = new java.sql.Time(tim.getTime());
